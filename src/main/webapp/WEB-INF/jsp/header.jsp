...
<div id="header"><a style="align-items: center" href="<c:url value="/home.html"/>"><img
    ...
    <ul id="navigation">
        <li><a href=""><spring:message code="tutorials.title"/> &raquo;</a>
            <ul>
                <li class="dropdownElement"><a class="dropdown"
                                               href="<c:url value="/addTutorial.html"/>"><spring:message
                        code="tutorials.create"/></a></li>
                <li class="dropdownElement"><a class="dropdown"
                                               href="<c:url value="/searchTutorial.html"/>"><spring:message
                        code="tutorials.search"/></a></li>
            </ul>
        </li>
        <li><a href=""><spring:message code="exercises.title"/> &raquo;</a>
            <ul>
                <li class="dropdownElement"><a class="dropdown"
                                               href="<c:url value="/addExercise.html"/>"><spring:message
                        code="exercises.create"/></a></li>
                <li class="dropdownElement"><a class="dropdown"
                                               href="<c:url value="/searchExercise.html"/>"><spring:message
                        code="exercises.search"/></a></li>
            </ul>
        </li>
